...
function generateMRDescription(issueIid: number, botName: string, claudeSummary: string, testResults?: string): string {
  let description = `This MR was automatically generated by ${botName} based on Issue #${issueIid}.\n\n`;

  if (claudeSummary) {
    description += `**${botName}'s Changes**:\n${claudeSummary}\n\n`;
  }
  ...
  description += `**Manual Review Reminder**: Please verify the changes meet expectations before merging.`;
